...
public class Utilize {
	...
	public String[][] exceldata() throws IOException {
		...
		String data="C:\\Users\\HAPPY\\Desktop\\GUVI Project\\BestBuyE-Commerce\\exceldata\\logintestdata.xlsx";
	...
	public void Selectdrop(String locator, String attributevalue,String visbletext) {
		...
		if (locator.equalsIgnoreCase("id")) {
			...
			WebElement xpath = driver.findElement(By.id(attributevalue));
	 ...
	 public String Screenshot(String Screenshotname) throws IOException {
		 ...
		 String path="C:\\Users\\HAPPY\\Desktop\\GUVI Project\\BestBuyE-Commerce\\testcasesnap"+Screenshotname+".png";
